...
class ResCompany(models.Model):
    ...
    def _check_lock_to_dates(self, vals):
        ...
        """
        period_lock_to_date = vals.get("period_lock_to_date") and time.strptime(
            vals["period_lock_to_date"], DEFAULT_SERVER_DATE_FORMAT
        )
        fiscalyear_lock_to_date = vals.get("fiscalyear_lock_to_date") and time.strptime(
            vals["fiscalyear_lock_to_date"], DEFAULT_SERVER_DATE_FORMAT
        )
        ...
        for company in self:
            old_fiscalyear_lock_to_date = (
                company.fiscalyear_lock_to_date
                and time.strptime(
                    company.fiscalyear_lock_to_date, DEFAULT_SERVER_DATE_FORMAT
                )
            )
