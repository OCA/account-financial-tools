...
class pxgo_set_invoice_ref_in_moves(osv.osv_memory):
    """
    Set Invoice Reference in Moves
    ...
    """
    _name = "pxgo_account_admin_tools.pxgo_set_invoice_ref_in_moves"
    ...
    _columns = {
        ...
        'period_ids': fields.many2many('account.period', 'pxgo_set_invoice_ref_in_moves_period_rel', 'wizard_id', 'period_id', "Periods"),
        'move_ids': fields.many2many('account.move', 'pxgo_set_invoice_ref_in_move_move_rel', 'wizard_id', 'move_id', 'Moves'),
    }
    ...
    def _next_view(self, cr, uid, ids, view_name, args=None, context=None):
        ...
        return {
            ...
            'res_model': 'pxgo_account_admin_tools.pxgo_set_invoice_ref_in_moves',
            'view_type': 'form',
            'view_mode': 'form',
    ...
    def action_skip_new(self, cr, uid, ids, context=None):
        ...
        """
        return self._next_view(cr, uid, ids, 'view_pxgo_set_invoice_ref_in_moves_ready_form', {'state': 'ready'}, context)
    ...
    def action_find_moves_with_wrong_invoice_ref(self, cr, uid, ids, context=None):
        ...
        for invoice in self.pool.get('account.invoice').browse(cr, uid, invoice_ids, context=context):
            if invoice.move_id:
                if not self._is_valid_reference(cr, uid, invoice.move_id.ref, invoice, context=context):
                    reference = self._get_reference(cr, uid, invoice, context=context)
        ...
        return self._next_view(cr, uid, ids, 'view_pxgo_set_invoice_ref_in_moves_ready_form', args, context)
    ...
    def action_set_invoice_ref_in_moves(self, cr, uid, ids, context=None):
        ...
        return self._next_view(cr, uid, ids, 'view_pxgo_set_invoice_ref_in_moves_done_form', args, context)


pxgo_set_invoice_ref_in_moves()
