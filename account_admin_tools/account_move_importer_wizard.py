...
class account_move_importer_wizard(osv.osv_memory):
    """
    Account Move Importer
    ...
    """
    _name = "account_move_importer_wizard"
    ...
    _columns = {
        ...
        'csv_delimiter': fields.char('Delimiter', size=1,
                                     required=True),
