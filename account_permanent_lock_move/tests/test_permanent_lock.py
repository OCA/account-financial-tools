    ...
    def test_name_completion(self):
        ...
        try:
            self.wizard = self.wizard_obj.create(
                {"company_id": self.company_id, "lock_date": fields.Date.today()}
            )
        ...
        self.assertTrue(
            raised_lock_error, "Permanent lock done even with unposted entry."
        )
        ...
        try:
            ...
            self.wizard = self.wizard_obj.create(
                {"company_id": self.company_id, "lock_date": yesterday}
            )
            self.wizard.confirm_date()
        except UserError as ue:
        ...
        self.assertTrue(raised_lock_error, "Permanent lock set the day before.")
        ...
        self.assertTrue(
            raised_create_error, "Journal Entry could be created after locking!"
        )
        ...
        self.assertTrue(
            raised_write_error, "Journal Entry could be modified after locking!"
        )
        ...
        self.assertTrue(
            raised_cancel_error, "Journal Entry could be cancelled after locking!"
        )
