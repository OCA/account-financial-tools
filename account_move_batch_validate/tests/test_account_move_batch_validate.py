...
class TestAccountMoveBatchValidate(SingleTransactionCase):
    ...
    def test_01_wizard_asynchronous_post(self):
        ...
        self.assertTrue(move.to_post, msg="Move should be marked as 'to post'.")
        self.assertTrue(
    ...
    def test_02_delete_move_before_job_run(self):
        ...
        self.assertTrue(bool(job_uuid), msg="The job has not been created.")
        ...
        self.assertEqual(
            post_job.result, "Nothing to do because the record has been deleted."
        )
    ...
    def test_03_mark_and_unmark(self):
        ...
        self.assertEqual(
            post_job.result, "Task set to Done because the user unmarked the move."
        )

        self.assertEqual(move.state, "draft", msg="Move should be in 'draft' state")
