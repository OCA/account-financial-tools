...
class StockInventory(models.Model):
        ...
        def post_inventory(self):
                if self.company_id.period_lock_date and (self.accounting_date == False or self.accounting_date <= self.company_id.period_lock_date):
...
class StockMoveLine(models.Model):
        ...
        def _rebuild_account_move(self):
                move = self.move_id
                if move.company_id.period_lock_date and (move.accounting_date == False or move.accounting_date <= move.company_id.period_lock_date):
