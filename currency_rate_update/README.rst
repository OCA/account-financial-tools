...
9. Eesti Pank (by Ventor.Tech, subsidiary of Xpansa)

10. National Bank Of Belarus (by Ventor.Tech, subsidiary of Xpansa)


Configuration
=============

To configure the module, go to *Accounting > Configuration > Accounting > Rate Auto-download* and create one or several services to download rates from the Internet.

Then, go to the page *Accounting > Configuration > Settings* and, in the section *Currencies*, make sure that the option *Auto-download Rates* is enabled.
...
* Nedas Zilinskas (Port to v11, Eesti Pank, National Bank Of Belarus)
