...
class TestCurrencyRateUpdate(TransactionCase):
    ...
    def test_cron_EE_EESTIPANK(self):
        """Test the ir.cron with Eesti Pank service for USD
        """
        self._test_cron_by_service('EE_EESTIPANK', ['base.USD'])

    def test_cron_BY_NBRB(self):
        """Test the ir.cron with National Bank Of Belarus service for USD
        """
        self._test_cron_by_service('BY_NBRB', ['base.USD'])
