    ...
    def run_currency_update(self):
        ...
        for company in companies:
            ...
            for service in company.services_to_use:
                ...
                next_run = datetime.combine(datetime.strptime(service.last_run, DEFAULT_SERVER_DATE_FORMAT), datetime.min.time()) + \
                    _intervalTypes[str(service.interval_type)](service.interval_number)
                if current_date == next_run.date():
                    try:
                        ...
                        service.write({'note': msg, 'last_run': next_run})
