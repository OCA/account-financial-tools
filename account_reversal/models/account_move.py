...
class AccountMove(models.Model):
    ...
    @api.constrains("to_be_reversed", "reversal_move_ids")
    ...
    def _get_reversal_id(self):
        # Although theoretically a o2o, reversal_move_ids is technically a o2m,
        ...
        self.ensure_one()
        return self.reversal_move_ids.filtered(lambda m: m.state != "cancel")[:1]
