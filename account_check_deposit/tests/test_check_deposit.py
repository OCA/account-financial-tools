...
class TestPayment(TransactionCase):
    def setUp(self):
        ...
        self.account_model.create(
            {
                ...
                "name": "Debtors - (test)",
                "reconcile": True,
                "user_type_id": self.ref(xid="account.data_account_type_receivable"),
        ...
        self.account_model.create(
            {
                ...
                "user_type_id": self.ref(xid="account.data_account_type_revenue"),
                "company_id": self.main_company.id,
            }
        )
        received_check_account = self.account_model.create(
            {
                ...
                "user_type_id": self.ref(
                    xid="account.data_account_type_current_assets"
                ),
                "company_id": self.main_company.id,
            }
        )
        ...
        self.manual_method_in = self.env.ref(
            xid="account.account_payment_method_manual_in"
        )
