...
class ManualFinancialProcess(FinancialTestCase):
    """ Story: Manual Financial Process
        ...
        As a Financial User
        I want to registry a manual payable
    ...
    def test_financial_payable_create(self):
        """Scenario 1: Financial payable of 100.00

        Given a financial payable
        ...
        financial_move = self.create_financial(
            ...
            account_id=self.env.ref("financial.financial_account_201008").id,
    ...
    def test_financial_payable_full_pay_one(self):
        ...
        When the user create one receipt item related to this payable
        and the receipt item amount is 100.00

        Then the financial payable should be paid
    ...
    def test_financial_payable_full_pay_multi(self):
        ...
        When the user create five receipt item related to this payable
