...
class TestModule(TransactionCase):
    def setUp(self):
        ...
        self.existing_subsequence_ids = (
            ...
            .search([("sequence_id", "=", self.sequence.id)])
            .ids
        )
    ...
    def test_method_normal(self):
        ...
        self.assertEqual(new_subsequences[0].date_to, date(2100, 12, 31))
    ...
    def test_method_company_setting_before(self):
        ...
        new_subsequences = self._get_new_subsequence()
        self.assertEqual(len(new_subsequences), 1)
        self.assertEqual(new_subsequences[0].date_from, date(2099, 4, 1))
        self.assertEqual(new_subsequences[0].date_to, date(2100, 3, 31))
    ...
    def test_method_company_setting_after(self):
        ...
        self.assertEqual(new_subsequences[0].date_to, date(2101, 3, 31))
