...
.. |badge3| image:: https://img.shields.io/badge/github-OCA%2Faccount--financial--tools-lightgray.png?logo=github
    :target: https://github.com/OCA/account-financial-tools/tree/19.0/account_move_group_restriction
    :alt: OCA/account-financial-tools
.. |badge4| image:: https://img.shields.io/badge/weblate-Translate%20me-F47D42.png
    :target: https://translation.odoo-community.org/projects/account-financial-tools-19-0/account-financial-tools-19-0-account_move_group_restriction
...
group, View Restricted Accounts, which implies
...
When Odoo's standard duplicate-bill detection finds a matching move that
the current user cannot read (because the match uses a restricted
account), that match is silently dropped from ``duplicated_ref_ids`` to
avoid leaking data. As a result, the form gives no hint that a hidden
potential duplicate exists. Surfacing a warning in that case was
considered but dropped as too costly for the limited business benefit.
...
`feedback <https://github.com/OCA/account-financial-tools/issues/new?body=module:%20account_move_group_restriction%0Aversion:%2019.0%0A%0A**Steps%20to%20reproduce**%0A-%20...%0A%0A**Current%20behavior**%0A%0A**Expected%20behavior**>`_.
...
This module is part of the `OCA/account-financial-tools <https://github.com/OCA/account-financial-tools/tree/19.0/account_move_group_restriction>`_ project on GitHub.
