...
class TestAccountCostCenter(AccountTestInvoicingCommon):
    ...
    def test_02_check_lines(self):
        ...
        self.invoice1.cost_center_id = self.costcenter
    ...
    def test_05_default_cost_center_on_lines(self):
        ...
        invoice.cost_center_id = self.costcenter
        invoice_form = Form(invoice)
        ...
        line_with_cost_center = invoice.invoice_line_ids.filtered(
            lambda lines: lines.cost_center_id
        )
        ...
        line_no_cost_center = invoice.invoice_line_ids.filtered(
            lambda lines: not lines.cost_center_id
        )
