...
![Cost centers can be configured](../static/description/account_costcenter_1.png)
...
![Cost centers can be selected on invoice lines](../static/description/account_costcenter_2.png)
...
![Cost centers can be selected on invoice lines](../static/description/account_costcenter_3.png)
