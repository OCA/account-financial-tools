...
[account_journal_general_sequence](account_journal_general_sequence/) | 16.0.1.0.4 | [![yajo](https://github.com/yajo.png?size=30px)](https://github.com/yajo) | Add configurable sequence to account moves, per journal
